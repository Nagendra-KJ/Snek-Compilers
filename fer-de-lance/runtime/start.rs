...
impl ErrCode {
    fn from_int(value: i32) -> Option<ErrCode> {
        match value {
            ...
            4 => Some(ErrCode::ArityMismatch),
            5 => Some(ErrCode::InvalidFunction),
            _ => None,
        }
    }
}
...
fn get_err_msg(err_enum: ErrCode) -> String {
    match err_enum {
        ...
        ErrCode::ArityMismatch => format!("arity mismatch"),
        ErrCode::InvalidFunction => format!("callee is not a function"),
    }
}
