...
success_tests! {
    ...
    {
        name: lam0,
        file: "./lambdas/lam0.snek",
        input: "0",
        expected: "6",
    },
    {
        name: lam1,
        file: "./lambdas/lam1.snek",
        input: "0",
        expected: "50",
    },
    {
        name: lam2,
        file: "./lambdas/lam2.snek",
        input: "0",
        expected: "(vec 6 50)",
    },
    {
        name: lam_compose,
        file: "./lambdas/lam-compose.snek",
        input: "100",
        expected: "102",
    },
    {
        name: lam_fac,
        file: "./lambdas/lam-fac.snek",
        input: "5",
        expected: "120",
    },
    {
        name: lam_map,
        file: "./lambdas/lam-map.snek",
        input: "100",
        expected: "(vec 110 (vec 120 (vec 130 false)))",
    },
    {
        name: lam_free0,
        file: "./lambdas/lam-free0.snek",
        input: "0",
        expected: "6"
    },
    {
        name: lam_free1,
        file: "./lambdas/lam-free1.snek",
        input: "0",
        expected: "(vec 6 15)"
    }
...
runtime_error_tests! {
    ...
    {
        name: lam_not_fun,
        file: "./lambdas/lam_not_fun.snek",
        input: "0",
        expected: "callee is not a function",
    },
    {
        name: lam_arity,
        file: "./lambdas/lam_arity.snek",
        input: "0",
...
static_error_tests! {
    ...
    {
        name:invalid_fun_missing_name,
        file: "./negative/invalid_fun_missing_name.snek",
        input: "0",
        expected: "Invalid"
    },
    {
        name:invalid_fun_missing_defn,
        file: "./negative/invalid_fun_missing_defn.snek",
        input: "0",
        expected: "Invalid"
    },
    {
        name:invalid_param_name,
        file: "./negative/invalid_param_name.snek",
        input: "0",
        expected: "Invalid"
    }
}
